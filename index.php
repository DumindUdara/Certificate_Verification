...
<body>
    ...
    <div class="container-fluid p-5" style="height: 100vh;background-color: #192145;">
        <div class="row ">
            <div class="col-12 col-lg-12 d-flex justify-content-end align-items-end">
                <a href="./view/register.view.php" class="btn btn-primary btn-sm">
     ...
     ?>
        <div class="row mt-5">
            <div class="col-12 col-lg-6 mx-auto">
                ...
                <h4 class="display-8 my-2 text-center fw-bold text-warning">DIGITAL-STUDYZ</h4>
                <form action="./controllers/GradeController.php" method="post">
                    ...
                    <div class="mt-4 form-group d-flex justify-content-center ">
                        <input type="submit" name="serach" value="Verify the certificate"
        ...
        <div class="box">
            <a href="./view/adminlogin.view.php" class='text-white' target="_self ">
                <div class="btn btn-success btn-sm">Admin Login</div>
            </a>
        </div>
    </div>
